    ...
    return (
      ...
      >
        ...
        >
          <Command>
            <CommandInput
              placeholder={t('global.multiselect.search.title')}
              onKeyDown={handleInputKeyDown}
            />
            <CommandList>
              <CommandEmpty>
                {t('global.multiselect.search.noResults')}
              </CommandEmpty>
              <CommandGroup>
                <CommandItem
                  key="all"
                ...
                >
                  ...
                  <span>({t('global.multiselect.selectAll')})</span>
                </CommandItem>
                {options.map((option) => {
